...
//				jsonObj.put("createdBy", "ShinyIngrid"); //Map Interface used internally=>key:value
				jsonObj.put("projectName", "Titanic");
...
//				jsonObj.put("teamSize", "10");
		    ...
		    Response resp = reqSpec.patch("http://49.249.28.218:8091/project/NH_PROJ_4698"); //passing projectID
			resp.then().log().all();
